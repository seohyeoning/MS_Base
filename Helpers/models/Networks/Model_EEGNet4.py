...
class EEGNet4(nn.Module): # 4 temporal, 2 spatial per temporal
    def __init__(self, num_classes, input_ch, input_time, track_running=True):
        ...
        self.convnet = nn.Sequential(
            nn.Conv2d(1, 4, kernel_size=(1, freq//3), stride=1, bias=False, padding=(1 , freq//6)),
            ...
            nn.Dropout(p=0.25),
            nn.Conv2d(8, 8, kernel_size=(1,freq//6),padding=(0,freq//6), groups=8),
...
#     model = EEGNet4(3, 28, 750, 10, True) # n_classes, n_channel, n_timewindow
#     # pred = model(torch.zeros(50, 1, 20, 250))
#     print(model)
#     from pytorch_model_summary import summary

#     print(summary(model, torch.rand((1, 1, 30, 750)), show_input=True))
